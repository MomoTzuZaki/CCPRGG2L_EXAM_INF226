public class Recursion {
    ...
    public static void main(String[] args) {
        ...
        String fullName = "paul andrei aguilar";
        removeLetter(fullName);
    }

    static void  removeLetter(String str) {
        // Add code here
            StringBuilder removeStr = new StringBuilder(str);
            System.out.println(removeStr);
            removeStr.deleteCharAt(0);
            System.out.println(removeStr);

            removeStr.deleteCharAt(2);
            System.out.println(removeStr);

            removeStr.deleteCharAt(4);
            System.out.println(removeStr);
            ...
            removeStr.deleteCharAt(8);
            System.out.println(removeStr);

            removeStr.deleteCharAt(10);
            System.out.println(removeStr);

            removeStr.deleteCharAt(9);
            System.out.println(removeStr);
